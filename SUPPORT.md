# Getting help with distplyr

Thanks for using distplyr! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/vincenzocoia/distplyr/issues/new).
...
requests](https://github.com/vincenzocoia/distplyr/issues) to make sure
