...
Thank you for considering contributing to `distplyr`! This package and
...
Conduct](https://distplyr.probaverse.com/CODE_OF_CONDUCT.md). By
...
`distplyr` follows the [tidyverse style
