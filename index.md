...
[contributing guide](https://distplyr.probaverse.com/CONTRIBUTING.md) to
get started.
...
this minimal example, we’ll only load `distplyr`, and the core
probaverse package, `distionary`.
...
![](reference/figures/README-extrema-1.png)

## Learn More

See
**[`vignette("manipulating")`](https://distplyr.probaverse.com/articles/manipulating.md)**
for a comprehensive guide to all verbs, including operators (`+`, `-`,
`*`, `/`), math functions ([`exp()`](https://rdrr.io/r/base/Log.html),
[`log()`](https://rdrr.io/r/base/Log.html),
[`sqrt()`](https://rdrr.io/r/base/MathFun.html)), and understanding when
operations simplify to known distributions.
...
[`vignette("manipulating")`](https://distplyr.probaverse.com/articles/manipulating.md)
for details on simplifications.
